    ...
    child: RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 6),
                const Text(
                  '1 hint = 1 credit. Packs are consumable and can be purchased repeatedly.',
                  textAlign: TextAlign.center,
                ),
              ],
            ),
          ...
          const SizedBox(height: 10),
          Text(
            'Target prices: 5 credits = \$0.51, then 10 credits = \$1.01 up to 100 credits = \$10.01. Final localized prices are set in Google Play Console.',
            textAlign: TextAlign.center,
            style: Theme.of(context).textTheme.bodySmall,
          ),
        ],
